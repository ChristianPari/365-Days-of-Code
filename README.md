...
Did some serious research and practice with recursion, and am beginning to really understand how powerful it is and how, when used correctly, can make algorithm solutions much cleaner<br>
...
Last two days were filled with javascript algorithms that utilized HTML and CSS to create buttons on the DOM that would cycle the buttons in a clockwise position via onclick event listener<br>
Began researching reactjs, may begin soon

<h2>Day 83</h2>

Day 7 algorithms completed using RegExp to match string inputs in various ways<br>
...
Day 6 algorithms that worked w/ JS classes and inheritance w/ sub classes, also ES6 arrow functions<br>
Making good progress in my music site, created artist routes and collection, moving towards albums now

<h2>Day 81</h2>

Day 5 Worked with creating #JS classes and sub classes and create/assign methods to these class prototypes<br>
...
Working in class movie rental project (pug reworked, patch and delete requests made to manipulate DB)<br>
